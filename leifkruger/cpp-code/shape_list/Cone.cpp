...
//Cone::Cone() {}
Cone::Cone(std::string _color, double _height, double _radius)
: Shape(_color), height (_height), radius (_radius) {}
...
void Cone::printArea() {
    cout << "The Cone area is: " << getArea() << endl;
}
void Cone::printVolume() {
    cout << "The Cone volume is: " << getVolume() << endl;
}